...
public class TaskgroupTest {
	...
	public DBTaskgroupService getJPA() {
		if (null == taskgroupJPA) {
			taskgroupJPA = DBRemoteEJBClient.getEJB(DBTaskgroupService.class.getName(), DBTaskgroupService.BEANNAME,
					ModulName.JPA);
		}
		return taskgroupJPA;
	}
	...
	public de.sqlcoach.beans.jdbc.interfaces.DBTaskgroupService getJDBC() {
		if (null == taskgroupJDBC) {
			taskgroupJDBC = DBRemoteEJBClient.getEJB(de.sqlcoach.beans.jdbc.interfaces.DBTaskgroupService.class.getName(),
					TaskgroupBeanJDBC.class.getSimpleName(), ModulName.JDBC);
		}
